...
//     };
//     use mpl_stoneage::{
//         accounts as mpl_stoneage_accounts, instruction as mpl_stoneage_instruction,
...
//     #[tokio::test]
//     async fn success() {
//         setup_context!(context, mpl_stoneage, mpl_token_metadata);
...
//         // CreateMarket
//         let accounts = mpl_stoneage_accounts::CreateMarket {
...
//         let data = mpl_stoneage_instruction::CreateMarket {
...
//         let accounts = mpl_stoneage_accounts::SavePrimaryMetadataCreators {
...
//         let data = mpl_stoneage_instruction::SavePrimaryMetadataCreators {
//             primary_metadata_creators_bump: primary_metadata_creators_bump,
//             creators: vec![mpl_stoneage::state::Creator {
...
//         // Buy
//         let accounts = mpl_stoneage_accounts::Buy {
//             market: market_keypair.pubkey(),
//             selling_resource: selling_resource_keypair.pubkey(),
...
//         let data = mpl_stoneage_instruction::Buy {
...
//         // CloseMarket
//         let accounts = mpl_stoneage_accounts::CloseMarket {
//             market: market_keypair.pubkey(),
...
//         let data = mpl_stoneage_instruction::CloseMarket {}.data();
...
//         let mut accounts = mpl_stoneage_accounts::Withdraw {
//             market: market_keypair.pubkey(),
//             selling_resource: selling_resource_keypair.pubkey(),
//             metadata,
//             treasury_holder: treasury_holder_keypair.pubkey(),
...
//         let data = mpl_stoneage_instruction::Withdraw {
//             payout_ticket_bump,
...
//         let accounts = mpl_stoneage_accounts::ClaimResource {
//             market: market_keypair.pubkey(),
//             treasury_holder: treasury_holder_keypair.pubkey(),
//             selling_resource: selling_resource_keypair.pubkey(),
//             selling_resource_owner: selling_resource_owner_keypair.pubkey(),
...
//         let data = mpl_stoneage_instruction::ClaimResource { vault_owner_bump }.data();
