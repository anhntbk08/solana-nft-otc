...
pub async fn setup_store(context: &mut ProgramTestContext) -> (Keypair, Keypair) {
    ...
    let accounts = mpl_stoneage_accounts::CreateStore {
    ...
    let data = mpl_stoneage_instruction::CreateStore {
        name: name.to_owned(),
...
pub async fn setup_selling_resource(
    ...
    let accounts = mpl_stoneage_accounts::InitSellingResource {
        store: store_keypair.pubkey(),
        admin: admin_wallet.pubkey(),
    ...
    let data = mpl_stoneage_instruction::InitSellingResource {
...
pub async fn setup_market(
    ...
    let data = mpl_stoneage_instruction::CreateMarket {
        ...
        vault_token_accounts: Vec::<Pubkey>::new(),
